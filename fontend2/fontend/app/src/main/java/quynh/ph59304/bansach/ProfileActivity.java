...
public class ProfileActivity extends AppCompatActivity {
    ...
    private Button btnLogout, btnChangeAvatar;
    ...
    private void initViews() {
        ...
        // Card views for clickable items
        com.google.android.material.card.MaterialCardView cardOrders = findViewById(R.id.cardOrders);
        com.google.android.material.card.MaterialCardView cardCoinWallet = findViewById(R.id.cardCoinWallet);
        com.google.android.material.card.MaterialCardView cardChangePassword = findViewById(R.id.cardChangePassword);
        ...
        if (cardCoinWallet != null) {
            cardCoinWallet.setOnClickListener(v -> {
                startActivity(new Intent(this, CoinWalletActivity.class));
            });
        }
    ...
    private void setupOrders() {
        // Handled in initViews() via card click
    }
